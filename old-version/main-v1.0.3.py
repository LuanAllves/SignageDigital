...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.delete_button = QPushButton("Delete") # Adicionado self. para conectar
        self.delete_button.setDisabled(True) # Começa desabilitado
        ...
        # A seleção de múltiplos itens é necessária para o delete
        self.media_list_widget.setSelectionMode(QListWidget.MultiSelection)
        # Conecta o sinal de mudança de seleção para habilitar/desabilitar o botão
        ...
        # Conecta o botão de delete ao método
    ...
    # Novo método para habilitar ou desabilitar o botão de delete
    def update_delete_button(self):
        # selectedItems() retorna a lista de itens selecionados
        selected_items = self.media_list_widget.selectedItems()
        # Habilita o botão se a lista não estiver vazia
        self.delete_button.setDisabled(len(selected_items) == 0)

    # Novo método para deletar os itens selecionados
    def delete_selected_items(self):
        # A forma mais segura de deletar é iterar de trás para frente
        for item in self.media_list_widget.selectedItems()[::-1]:
