...
from PySide6.QtGui import QPixmap, QColor, QFont, QImage # QImage para conversão do OpenCV
from PySide6.QtCore import Qt, QSize, Signal, QBuffer, QIODevice # QBuffer e QIODevice para conversão
# ================ Fim das Importações ======================
...
class MediaItemWidget(QWidget):
    ...
    def __init__(self, media_id, media_name, media_type, file_path, scheduled_date, parent=None):
        ...
        # Chama a função para carregar a miniatura real
    ...
    def load_thumbnail(self, file_path):
        ...
        if not os.path.exists(file_path):
            print(f"Arquivo não encontrado: {file_path}. Exibindo placeholder.")
    ...
    def _load_video_thumbnail(self, file_path):
        """Extrai o primeiro frame de um vídeo como miniatura."""
        ...
        ret, frame = cap.read() # Lê o primeiro frame
        if ret:
...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.media_list_widget.setGridSize(QSize(THUMBNAIL_WIDTH + 180, THUMBNAIL_HEIGHT + 50)) # Ajusta o gridSize
        self.media_list_widget.setIconSize(QSize(THUMBNAIL_WIDTH, THUMBNAIL_HEIGHT)) # Ajusta o iconSize
    ...
    def load_media_from_db(self):
        ...
        for media in medias:
            ...
            # Passa o file_path para o add_media_item
            self.add_media_item(media_id, name, media_type, file_path, schedule_text)

    def add_media_item(self, media_id, name, type, file_path, date):
        item_widget = MediaItemWidget(media_id, name, type, file_path, date)
    ...
    def upload_media(self):
        ...
        if file_dialog.exec():
            ...
            for file_path in selected_files:
                ...
                # Passa o file_path para o add_media_item
                self.add_media_item(media_id, file_name, file_type, file_path, "Não agendado")
