...
class MediaDisplayWindow(QWidget):
    def __init__(self, media_list, is_muted_at_start=True):
        ...
        # Define o estado inicial do áudio
        self.set_muted(is_muted_at_start)
        
        # Para controlar a duração de imagens
...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.toggle_audio(initial=True) # Define o estado inicial do ícone
    ...
    def toggle_audio(self, initial=False):
        ...
        # Se a janela de reprodução estiver aberta, atualiza o áudio
        if self.player_window:
