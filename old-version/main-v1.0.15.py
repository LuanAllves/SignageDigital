...
from PySide6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout,
                               ...
                               QSpinBox, QDateEdit) # QDateEdit é novo
from PySide6.QtGui import QPixmap, QColor, QFont, QImage
from PySide6.QtCore import Qt, QSize, Signal, QBuffer, QIODevice, QDate, QTime # QDate e QTime para preencher os widgets
# ================ Fim das Importações ======================
...
class MediaEditDialog(QDialog):
    def __init__(self, media_type, duration_seconds, scheduled_data, parent=None):
        ...
        # Conexões de sinal para o botão de limpar agendamento
        self.clear_end_button.clicked.connect(self._clear_end_schedule)
        
        # Conexão para reabilitar os campos quando o usuário interage com eles
    ...
    def _clear_end_schedule(self):
        ...
        self._set_end_schedule_enabled(False) # Chamar o novo método para desabilitar
    ...
    def get_schedule_data(self):
        ...
        end_date = None
        end_time = None
        # AQUI ESTÁ A CORREÇÃO: Usar .isEnabled() em vez de .isDisabled()
...
class MainWindow(QMainWindow):
    ...
    def open_schedule_dialog(self, media_item_widget):
        # Passa os dados existentes para o dialog
        scheduled_data = {
        ...
        if dialog.exec():
            ...
            # Atualiza os dados no objeto do widget para que as labels possam ser atualizadas
