...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.screens = QApplication.screens() # Adicionado para obter as telas
        self.setup_ui()
    ...
    def get_selected_screen(self):
        ...
        if checked_id != -1:
            return self.screens[checked_id]
        return None
    ...
    def play_media(self):
        ...
        if not selected_screen:
            # Caso nenhuma tela seja selecionada, usa a tela padrão
            selected_screen = QApplication.primaryScreen()
        
        self.player_window = MediaDisplayWindow(media_list, is_muted_at_start=self.is_muted)
        
        # Move a janela para a tela selecionada antes de exibi-la
