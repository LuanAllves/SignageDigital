...
VIDEO_THUMBNAIL_FRAME = 5 # O frame que queremos pegar
...
class MediaItemWidget(QWidget):
    ...
    def _load_video_thumbnail(self, file_path):
        ...
        # Pega a contagem total de frames do vídeo
        frame_count = int(cap.get(cv2.CAP_PROP_FRAME_COUNT))
        
        # Define o frame para o qual queremos pular
        target_frame = VIDEO_THUMBNAIL_FRAME
        
        # Garante que o frame alvo existe no vídeo
        if target_frame >= frame_count:
            target_frame = 0 # Volta para o primeiro frame se o alvo não existir
