...
class MediaDisplayWindow(QWidget):
    ...
    def start_playback(self):
        # showFullScreen agora eh chamado no MainWindow
    ...
    def stop_playback(self):
        ...
        self.close()
        self.deleteLater() # adicionado para liberar a memoria de forma segura
...
class MainWindow(QMainWindow):
    ...
    def play_media(self):
        ...
        # Se já existe uma janela anterior
        if self.player_window:
            if Shiboken.isValid(self.player_window):  # <-- checa se não foi destruída
