...
class MediaItemWidget(QWidget):
    ...
    def __init__(self, media_name, media_type, scheduled_date, parent=None):
        ...
        self.schedule_label.setWordWrap(True) # <--- AQUI ESTÁ A CORREÇÃO
...
class MainWindow(QMainWindow):
    ...
    def open_schedule_dialog(self, media_item_widget):
        ...
        if dialog.exec():
            ...
            media_item_widget.set_schedule_text(f"<br> {start} <br> {end}")

    def update_delete_button(self):
        # Habilita ou desabilita o botão de delete com base na seleção de itens
