...
class MainWindow(QMainWindow):
    ...
    def populate_screen_selector(self):
        ...
        for i, screen in enumerate(screens):
            ...
            # Armazena o objeto QScreen como um atributo no botão
            radio_button.screen = screen
    ...
    def get_selected_screen(self):
        ...
        checked_button = self.screen_button_group.checkedButton()
        if checked_button:
            # Retorna o objeto QScreen que foi salvo como atributo do botão
            return checked_button.screen
